  ...
  if(strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
   // $first_name_err = $last_name_err = $country_err = $address_err = $city_err = $phone_err = $email_err = $addition_opt_err = $payment_method_err = "";
    ...
    if(isset($_POST['firstname']) && !empty(trim($_POST['firstname']))) {
      ...
      echo '<script language="javascript">alert("Vui lòng cung cấp First name"); window.location="checkout.php";</script>'; die();
    }

    if(isset($_POST['lastname']) && !empty(trim($_POST['lastname']))) 
      $last_name = trim($_POST['lastname']); 
    else {
      echo '<script language="javascript">alert("Vui lòng cung cấp Last name "); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['country']) && !empty(trim($_POST['country']))) 
      ...
      echo '<script language="javascript">alert("Vui lòng cung cấp Country); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['address']) && !empty(trim($_POST['address']))) 
      ...
      echo '<script language="javascript">alert("Vui lòng cung cấp Address); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['city']) && !empty(trim($_POST['city']))) 
      ...
      echo '<script language="javascript">alert("Vui lòng cung cấp City"); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['phone']) && !empty(trim($_POST['phone']))) 
      ...
      echo '<script language="javascript">alert("Vui lòng cung cấp Phone); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['email']) && !empty(trim($_POST['email']))) 
      ...
      echo '<script language="javascript">alert("Vui lòng cung cấp Email); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['addition-opt']) && !empty(trim($_POST['addition-opt']))) 
      ...
      echo '<script language="javascript">alert("Nhập ghi chú đặt hàng"); window.location="checkout.php";</script>'; die();
    }
    ...
    if(isset($_POST['payment-method']) && !empty(trim($_POST['payment-method']))) {
     ...
     // $payment_method_err = "<script>alert('Vui lòng chọn phương thức thanh toán')</script>";
      echo '<script language="javascript">alert("Vui lòng chọn phương thức thanh toán"); window.location="checkout.php";</script>'; die();
    }
